...
"")
        ...
        self.lineEdit.setMaximumSize(QSize(300, 50))
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, QCoreApplication.translate("MainWindow", u"mV", None))
        self.comboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"Nm", None))
        self.comboBox.setItemText(2, QCoreApplication.translate("MainWindow", u"Kg", None))
        self.comboBox.setItemText(3, QCoreApplication.translate("MainWindow", u"N", None))

        self.comboBox.setCurrentText(QCoreApplication.translate("MainWindow", u"mV", None))
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"NOME FILE", None))
    # retranslateUi
