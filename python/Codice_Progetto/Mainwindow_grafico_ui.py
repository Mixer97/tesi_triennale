...
"")
        ...
        self.frame_4.setStyleSheet(u"    border-width: 1px;")
        ...
        sizePolicy3.setHeightForWidth(self.stackedWidget_SG600.sizePolicy().hasHeightForWidth())
        self.stackedWidget_SG600.setSizePolicy(sizePolicy3)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.pushButton_autorange_main.sizePolicy().hasHeightForWidth())
        self.pushButton_autorange_main.setSizePolicy(sizePolicy5)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.pushButton_autorange_temp.sizePolicy().hasHeightForWidth())
        self.pushButton_autorange_temp.setSizePolicy(sizePolicy5)
...
"}")
        ...
        sizePolicy4.setHeightForWidth(self.graphWidget_SG600_main.sizePolicy().hasHeightForWidth())
        self.graphWidget_SG600_main.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.graphWidget_SG600_temp.sizePolicy().hasHeightForWidth())
        self.graphWidget_SG600_temp.setSizePolicy(sizePolicy4)
        ...
        sizePolicy6.setHeightForWidth(self.stackedWidget_Laumas.sizePolicy().hasHeightForWidth())
        self.stackedWidget_Laumas.setSizePolicy(sizePolicy6)
...
"}")
        ...
        sizePolicy3.setHeightForWidth(self.page_CH3.sizePolicy().hasHeightForWidth())
        self.page_CH3.setSizePolicy(sizePolicy3)
