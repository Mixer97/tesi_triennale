...
"")
    ...
    #------------------------------------------------------------------------------------------------------------------------#
        ...
        self.lineEdit_fondoscala.setText(str(Controller_Client_TCP_Laumas.DATA.LIST_FULLSCALE[1]))
        self.lineEdit_sensibilita.setText(str(Controller_Client_TCP_Laumas.DATA.LIST_SENSIBILITY[1]))
    ...
    def update_fondoscala(self):
        ...
        if is_number_tryexcept(new_value):
            Controller_Client_TCP_Laumas.DATA.LIST_FULLSCALE[1] = float(new_value)
        else:
    ...
    def update_sensibilità(self):
        ...
        if is_number_tryexcept(new_value):
            Controller_Client_TCP_Laumas.DATA.LIST_SENSIBILITY[1] = float(new_value)
        else:
            print("Valore inserito non rappresenta un numero")
