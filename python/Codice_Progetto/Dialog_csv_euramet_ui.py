...
"}")
    ...
    def retranslateUi(self, Dialog_csv_euramet):
        ...
        self.lineEdit_unita_ingegneristica_di_misura.setText(QCoreApplication.translate("Dialog_csv_euramet", u"-", None))
        ...
        self.lineEdit_unita_ingegneristica_UUT.setText(QCoreApplication.translate("Dialog_csv_euramet", u"-", None))
        self.label_scale.setText(QCoreApplication.translate("Dialog_csv_euramet", u"Scale [Nm/V]", None))
        self.lineEdit_scale.setText(QCoreApplication.translate("Dialog_csv_euramet", u"-", None))
        self.label_offset.setText(QCoreApplication.translate("Dialog_csv_euramet", u"Offset [V]", None))
        self.lineEdit_offset.setText(QCoreApplication.translate("Dialog_csv_euramet", u"-", None))
        self.label_coppia_taratura_max.setText(QCoreApplication.translate("Dialog_csv_euramet", u"Coppia taratura MAX [Nm]", None))
        self.lineEdit_coppia_taratura_max.setText(QCoreApplication.translate("Dialog_csv_euramet", u"-", None))
