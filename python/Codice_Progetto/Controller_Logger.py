...
def execute_logger(nome_CSV):
    
    logger = Logger(nome_CSV)
    path_CSV = logger.CSV_path_getter()
...
if __name__ == "__main__":
    View.startStop_logger = True
    execute_logger(nome_CSV="test")
