...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.pushButton_error.sizePolicy().hasHeightForWidth())
        self.pushButton_error.setSizePolicy(sizePolicy2)
